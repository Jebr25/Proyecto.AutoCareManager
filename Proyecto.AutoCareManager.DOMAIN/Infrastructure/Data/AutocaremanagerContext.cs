...
namespace Proyecto.AutoCareManager.DOMAIN.Infrastructure.Data;
...
public partial class AutocaremanagerContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ActId).HasName("PK__tb_actSe__AF1624FCFCC986C9");
        ...
        {
            entity.HasKey(e => e.CodArticulo).HasName("PK__tb_artic__BEC60837585ABE10");
        ...
        {
            entity.HasKey(e => e.CodEmpleado).HasName("PK__tb_emple__35FE54ABA897CCDD");
        ...
        {
            entity.HasKey(e => e.DocId).HasName("PK__tb_factV__3EF1888D2AB73CE5");
        ...
        {
            entity.HasKey(e => e.CodSn).HasName("PK__tb_socio__F416211716F16D78");
        ...
        {
            entity.HasKey(e => e.CodTaller).HasName("PK__tb_talle__BCCE6CE446B2E2C3");
        ...
        {
            entity.HasKey(e => e.UserCode).HasName("PK__tb_usuar__A039F1EFFB876CE8");
        ...
        {
            entity.HasKey(e => e.CodVehiculo).HasName("PK__tb_vehic__75D37F6C70692159");
